  ...
  return (
    <>
      <div className="flex items-center gap-2 text-green-500 text-[13px] font-medium">
        <span className="w-5 h-5 bg-green-500 rounded-full flex items-center justify-center shrink-0 my-5">
      ...
      <div className="flex items-center my-5 gap-2 bg-gray-100 rounded-full py-1.5 pl-1.5 pr-4 text-[12px] text-gray-700 max-w-full">
